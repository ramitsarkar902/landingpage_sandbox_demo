...
function Services() {
  return (
    <section id="services" class="sectionStyle mb-5">
      <div className="wrapper bg-white py-5 mb-5">
        <div className="container py-14 py-md-17">
          <div class="row gx-lg-8 gx-xl-12 gy-6 mb-10 align-items-center">
            <div class="col-lg-6  w-full order-lg-2 ">
              <ul class="progress-list ">
                ...
                <li>
                  <div class="pt-3 pb-1 d-flex flex-row justify-content-between">
                    <p>Strategy</p>
                    <p>80%</p>
                  </div>
                  <div class="progress" data-value="100">
            ...
            <div class="col-lg-6 mb-3 serviceDivCustom">
          ...
          <div className="row gx-lg-8 gx-xl-12 gy-6 gy-md-0 text-center service_bottom serviceDivCustom">
            <div class="col-md-6 col-lg-3 p-lg-5 p-sm-2 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 409.6 362.5"
                data-inject-url="https://sandbox.elemisthemes.com/assets/img/icons/lineal/megaphone.svg"
                class=" icon_svg_services"
              >
                <path
                  class="lineal-stroke"
            ...
            <div class="col-md-6 col-lg-3 p-lg-5 p-sm-2">
              <svg
                ...
                data-inject-url="https://sandbox.elemisthemes.com/assets/img/icons/lineal/settings-3.svg"
                class="icon_svg_services"
              >
                <path
                  class="lineal-fill"
            ...
            <div class="col-md-6 col-lg-3 p-lg-5 p-sm-2">
              <svg
                ...
                data-inject-url="https://sandbox.elemisthemes.com/assets/img/icons/lineal/bar-chart.svg"
                class="icon_svg_services"
              >
                <path
                  class="lineal-fill"
